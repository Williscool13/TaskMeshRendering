...
ImguiWrapper::ImguiWrapper(VulkanContext* context, SDL_Window* window, int32_t swapchainImageCount, VkFormat renderAttachmentFormat)
    : context(context)
{
    ...
    initInfo.PipelineInfoMain.PipelineRenderingCreateInfo.pColorAttachmentFormats = &renderAttachmentFormat;
