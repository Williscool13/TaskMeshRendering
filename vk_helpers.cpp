...
VkImageSubresourceRange SubresourceRange(const VkImageAspectFlags aspectMask, const uint32_t levelCount, const uint32_t layerCount)
{
    return {
...
VkImageSubresourceRange SubresourceRange(const VkImageAspectFlags aspectMask, const uint32_t baseMipLevel, const uint32_t levelCount, const uint32_t baseArrayLayer, const uint32_t layerCount)
{
    return {
        .aspectMask = aspectMask,
...
VkCommandBufferAllocateInfo CommandBufferAllocateInfo(uint32_t bufferCount, VkCommandPool commandPool)
{
    return {
